...
for s in shapes:
  ...
  // ============ OOP: self & cls Keywords ============
  {
    title: "Instance Tracker with self",
    description: "Use self to track instance state and method chaining. Each instance should track how many times methods are called.",
    topic: "OOP: self & cls",
    level: "Medium",
...
print(c.get_status())`,
  ...
  {
    title: "Class Factory with cls",
    description: "Use @classmethod with cls to create factory methods that build objects in different ways.",
    topic: "OOP: self & cls",
    level: "Hard",
...
print(e3)`,
  ...
  // ============ OOP: __init__, __new__, __del__ ============
  {
    title: "Singleton Pattern with __new__",
    description: "Implement the Singleton pattern using __new__ so only one instance of the class can exist.",
    topic: "OOP: __init__ & __new__",
    level: "Hard",
    starter: `class Database:
    _instance = None
...
print(f"db2.name: {db2.name}")`,
  ...
  {
    title: "Resource Manager with __del__",
    description: "Create a class that simulates opening and closing resources, with __del__ for cleanup.",
    topic: "OOP: __init__ & __new__",
    level: "Medium",
    starter: `class FileHandler:
    _open_files = []
...
f1.close()
print(f"After close: {FileHandler._open_files}")`,
...
print(f"After close: {FileHandler._open_files}")`,
  ...
  // ============ OOP: Polymorphism ============
  {
    ...
    description: "Implement polymorphism where different animals make different sounds through the same interface.",
...
describe_animal(Cat())`,
  ...
  {
    title: "Math Operations with Operator Overloading",
    description: "Implement polymorphism through magic methods to make custom objects work with built-in operators.",
    topic: "OOP: Polymorphism",
    level: "Hard",
...
print(f"|v1| = {abs(v1)}")`,
  ...
  // ============ OOP: Encapsulation ============
  {
    ...
    description: "Protect bank account data using private attributes and properties for controlled access.",
...
print(acc.statement)`,
  ...
  {
    title: "Validated User Profile",
    description: "Use @property with validation to protect user data integrity.",
    topic: "OOP: Encapsulation",
    level: "Medium",
    starter: `class UserProfile:
...
print(profile)`,
  ...
  // ============ OOP: Abstraction ============
  {
    ...
    description: "Create an abstract payment processor with concrete implementations for different payment methods.",
...
for proc in processors:
  ...
  },
  {
    ...
    description: "Build an abstract Shape class and implement concrete shapes with area and perimeter calculations.",
    topic: "OOP: Abstraction",
    level: "Hard",
    starter: `from abc import ABC, abstractmethod
import math
