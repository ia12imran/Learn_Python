(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,8053,28804,e=>{"use strict";let t=[{slug:"intro",title:"Python Introduction",icon:"rocket",description:"What is Python and why learn it?",level:"beginner",lessons:[{slug:"what-is-python",title:"What is Python?",description:"Learn what Python is and why it's so popular.",content:`Python is a high-level, interpreted, general-purpose programming language created by Guido van Rossum and first released in 1991.
...
print("Hello".center(20, "-"))`,practiceCode:`# Try printing your name
name = "Your Name"
print(f"Hello, {name}!")
...
print(f"Student: {is_student}")`,practiceCode:`# Create your own variables
name = "Your Name"
age = 20
language = "Python"
...
print(f"I am learning {language}")`,practiceTask:"Create variables for your name, age, and favorite language. Print them using f-strings.",quiz:[{question:"What is the output of: x = 5; print(x + 3)?",options:["53","8","5 + 3","Error"],correctIndex:1,explanation:"x = 5, so x + 3 = 8"},{question:"Which file extension is used for Python files?",options:[".python",".py",".pt",".pyt"],correctIndex:1,explanation:"Python files use the .py extension."}]}]},{slug:"syntax",title:"Python Syntax",icon:"code",description:"Learn Python syntax rules and basics.",level:"beginner",lessons:[{slug:"basic-syntax",title:"Basic Syntax",description:"Understanding Python's syntax rules.",content:`**Key Syntax Rules:**
...
a, b = 10, 20
a, b = b, a
print(f"a={a}, b={b}")`,practiceCode:`# Create variables of different types
integer_var = 42
float_var = 3.14
string_var = "Hello"
bool_var = True
...
x = "100"
y = int(x) + 50
print(f"Converted: {y}")  # 150`,practiceCode:`# Check types and convert
...
num_str = "256"
num = int(num_str)
print(f"Square of {num}: {num ** 2}")`,practiceTask:"Print each data type and its value. Convert the string '256' to int and print its square.",quiz:[{question:"What is the type of [1, 2, 3]?",options:["tuple","list","array","set"],correctIndex:1,explanation:"[1, 2, 3] is a list (square brackets)."},{question:'What does int("42") return?',options:['"42"',"42 (string)","42 (integer)","Error"],correctIndex:2,explanation:"int() converts the string '42' to the integer 42."}]}]},{slug:"strings",title:"Python Strings",icon:"type",description:"Working with text data in Python.",level:"beginner",lessons:[{slug:"string-basics",title:"String Basics",description:"Creating and using strings.",content:`**Strings** are sequences of characters enclosed in quotes.
...
# Escape characters
print("Line 1\\nLine 2")
print("She said \\"Hello\\"")`,practiceCode:`# Practice string operations
word = "Python"
...
print("a,b,c".split(","))
print("-".join(["2024", "01", "01"]))`,practiceCode:`# Practice string methods
...
joined = " | ".join(fruits)
print(f"Joined: {joined}")`,practiceTask:"Clean up the messy string using strip, lower, and title methods. Split a CSV string and rejoin with pipes.",quiz:[{code:'text = "  Hello  "',question:"What does text.strip() return?",options:['"  Hello"','"Hello"','"Hello  "','"  Hello  "'],correctIndex:1,explanation:".strip() removes whitespace from both ends."},{question:'What does "a,b,c".split(",") return?',options:['"a,b,c"','["a","b","c"]','("a","b","c")','{"a","b","c"}'],correctIndex:1,explanation:".split(',') returns a list of substrings."}]},{slug:"string-formatting",title:"String Formatting",description:"Formatting strings with f-strings and more.",content:`**Three ways to format strings:**
...
print(f"Percentage: {0.95:.0%}")`,practiceCode:`# Practice f-string formatting
product = "Laptop"
price = 999.99
quantity = 5
...
print(f"Scientific: {0.00123:.2e}")`,practiceTask:"Create a product receipt using f-strings. Format a table with item, price, quantity, and total columns.",quiz:[{code:"x = 3.14159",question:'What does f"{x:.2f}" produce?',options:["3.14","3.14159","3.1","3"],correctIndex:0,explanation:".2f formats to 2 decimal places: 3.14"},{question:"Which is the recommended modern way to format strings?",options:["% formatting",".format()","f-strings","string.concat()"],correctIndex:2,explanation:"f-strings (Python 3.6+) are the most readable and performant."}]}]},{slug:"operators",title:"Python Operators",icon:"calculator",description:"Arithmetic, comparison, and logical operators.",level:"beginner",lessons:[{slug:"arithmetic-operators",title:"Arithmetic Operators",description:"Math operations in Python.",content:"**Arithmetic Operators:**\n\n| Operator | Name | Example | Result |\n|----------|------|---------|--------|\n| `+` | Addition | `5 + 3` | `8` |\n| `-` | Subtraction | `5 - 3` | `2` |\n| `*` | Multiplication | `5 * 3` | `15` |\n| `/` | Division | `5 / 3` | `1.6667` |\n| `//` | Floor Division | `5 // 3` | `1` |\n| `%` | Modulus | `5 % 3` | `2` |\n| `**` | Exponent | `5 ** 3` | `125` |\n\n**Operator precedence** (PEMDAS):\n1. `**` (exponent)\n2. `+`, `-` (unary)\n3. `*`, `/`, `//`, `%`\n4. `+`, `-`",codeExample:`a, b = 17, 5
...
print(f"  Leftover: {100 % 3}")`,practiceCode:`# Calculator operations
x = 48
y = 7
...
print(f"\\n{total_seconds} seconds = {hours}h {minutes}m {seconds}s")`,practiceTask:"Convert 3661 seconds into hours, minutes, and seconds using floor division and modulus.",quiz:[{question:"What is 17 // 5?",options:["3.4","3","4","2"],correctIndex:1,explanation:"// is floor division - it rounds down to 3."},{question:"What is 17 % 5?",options:["3","2","3.4","175"],correctIndex:1,explanation:"% gives the remainder: 17 = 3*5 + 2, so remainder is 2."}]},{slug:"comparison-operators",title:"Comparison Operators",description:"Comparing values in Python.",content:"**Comparison Operators:**\n\n| Operator | Meaning | Example |\n|----------|---------|---------|\n| `==` | Equal to | `5 == 5` → `True` |\n| `!=` | Not equal | `5 != 3` → `True` |\n| `>` | Greater than | `5 > 3` → `True` |\n| `<` | Less than | `5 < 3` → `False` |\n| `>=` | Greater or equal | `5 >= 5` → `True` |\n| `<=` | Less or equal | `5 <= 3` → `False` |\n\n**Chained comparisons:**\n```python\nx = 5\nprint(1 < x < 10)    # True\nprint(1 < x < 3)     # False\n```",codeExample:`x, y = 10, 20
...
print(f'"abc" == "abc": {"abc" == "abc"}')`,practiceCode:`# Comparison practice
score = 85
grade = ""
...
# Test chaining
temperature = 25
print(f"{temperature}C is comfortable: {20 <= temperature <= 30}")`,practiceTask:"Write code that assigns a letter grade (A-F) based on a score using comparison operators.",quiz:[{question:"What is the result of: 5 != 5?",options:["True","False","5","Error"],correctIndex:1,explanation:"5 != 5 is False because 5 is equal to 5."},{question:"Which checks if two values are NOT equal?",options:["==","!=","<>","!="],correctIndex:1,explanation:"!= is the not-equal operator."}]},{slug:"logical-operators",title:"Logical Operators",description:"and, or, not operators.",content:"**Logical Operators:**\n\n| Operator | Description | Example |\n|----------|-------------|---------|\n| `and` | True if BOTH are true | `True and False` → `False` |\n| `or` | True if AT LEAST ONE is true | `True or False` → `True` |\n| `not` | Reverses the boolean | `not True` → `False` |\n\n**Truth table for `and`:**\n```\nTrue and True   → True\nTrue and False  → False\nFalse and True  → False\nFalse and False → False\n```\n\n**Truth table for `or`:**\n```\nTrue or True   → True\nTrue or False  → True\nFalse or True  → True\nFalse or False → False\n```\n\n**Short-circuit evaluation:**\nPython stops evaluating as soon as the result is determined.\n```python\nx = 0\nresult = x != 0 and 10 / x > 2  # Safe! Won't divide by zero\n```",codeExample:`age = 25
has_id = True
is_vip = False
...
print(f"Name: {display}")`,practiceCode:`# Logical operators practice
username = "admin"
password = "secret123"
is_active = True
...
print(f"bool(42) = {bool(42)}")`,practiceTask:"Write a login check that requires username='admin', password='secret', and is_active=True. Also test truthy/falsy values.",quiz:[{question:"What is True and False?",options:["True","False","None","Error"],correctIndex:1,explanation:"and requires BOTH to be True. Since one is False, result is False."},{question:"What is not False or True?",options:["False","True","None","Error"],correctIndex:1,explanation:"not False = True, then True or True = True"}]}]},{slug:"control-flow",title:"Control Flow",icon:"git-branch",description:"If/else statements and loops.",level:"beginner",lessons:[{slug:"if-else",title:"If / Elif / Else",description:"Conditional statements.",content:`**If/Elif/Else** controls program flow based on conditions.
...
print(f"{number} is {parity}")`,practiceCode:`# Grade calculator
...
print(f"Score: {score}")
print(f"Grade: {grade}")
print(f"Comment: {comment}")`,practiceTask:"Create a program that takes a score (use 85 as default) and outputs the grade (A-F) with a comment.",quiz:[{question:"How many elif blocks can an if statement have?",options:["1","2","Unlimited","0"],correctIndex:2,explanation:"You can have unlimited elif blocks, plus one else."},{question:"What does the _ case do in match?",options:["Matches everything","Default case","Error","Nothing"],correctIndex:1,explanation:"_ is the wildcard/default case in match statements."}]},{slug:"for-loops",title:"For Loops",description:"Iterating with for loops.",content:`**For loops** iterate over a sequence (list, string, range, etc.)
...
for i in range(1, 4):
    ...
    print()`,practiceCode:`# Practice loops
...
print("\\nTriangle:")
for i in range(1, 6):
    print("*" * i)`,practiceTask:"Print even numbers 1-20, calculate sum of 1-100, compute 5!, and print a triangle pattern of stars.",quiz:[{question:"What does range(1, 5) produce?",options:["1,2,3,4,5","1,2,3,4","0,1,2,3,4","1,2,3"],correctIndex:1,explanation:"range(1, 5) generates 1, 2, 3, 4 (stop is exclusive)."},{question:"What does enumerate() return?",options:["Just values","Just indices","Index-value pairs","Nothing"],correctIndex:2,explanation:"enumerate() returns (index, value) pairs."}]},{slug:"while-loops",title:"While Loops",description:"Looping with while.",content:`**While loops** repeat as long as a condition is True.
...
for i in range(1, 16):
    ...
    if i > 12:
        break
    print(f"  {i}", end="")
print()`,practiceCode:`# While loop exercises
# Countdown
print("Countdown:")
n = 10
while n > 0:
...
print(f"'red' in colors: {'red' in colors}")`,practiceCode:`# List practice
...
print(f"Bottom 3: {scores[-3:]}")`,practiceTask:"Create a list of 5 scores. Find max, min, average. Add a new score, sort it, and print top 3.",quiz:[{question:"Which method adds an element to the end of a list?",options:[".add()",".append()",".insert()",".push()"],correctIndex:1,explanation:".append() adds an element to the end of a list."},{question:"What does [1,2,3][1] return?",options:["1","2","3","[2]"],correctIndex:1,explanation:"Index 1 is the second element: 2."}]},{slug:"list-comprehension",title:"List Comprehension",description:"Creating lists concisely.",content:`**List comprehension** creates new lists from expressions.
...
print(f"Labels: {labels}")`,practiceCode:`# List comprehension practice
...
print(f"Transposed: {transposed}")`,practiceTask:"Use list comprehensions to: cube odd numbers, clean strings, convert scores to grades, and transpose a matrix.",quiz:[{question:"What does [x*2 for x in range(3)] produce?",options:["[2, 4, 6]","[0, 2, 4]","[1, 2, 3]","[0, 1, 2]"],correctIndex:1,explanation:"range(3) = 0,1,2, each multiplied by 2 = 0,2,4"},{question:"Where does the filter condition go?",options:["Before for","After for, before if","At the end","Before the expression"],correctIndex:1,explanation:"Syntax: [expr for item in iterable if condition]"}]}]},{slug:"functions",title:"Python Functions",icon:"function-square",description:"Creating reusable code blocks.",level:"intermediate",lessons:[{slug:"function-basics",title:"Function Basics",description:"Defining and calling functions.",content:'**Functions** are reusable blocks of code.\n\n```python\ndef function_name(parameters):\n    """Docstring - describes what the function does."""\n    # code block\n    return result\n```\n\n**Key concepts:**\n- `def` keyword starts function definition\n- Parameters are optional\n- `return` sends a value back (optional)\n- Without `return`, function returns `None`\n\n**Default parameters:**\n```python\ndef greet(name, greeting="Hello"):\n    return f"{greeting}, {name}!"\n```\n\n**Multiple return values:**\n```python\ndef get_stats(numbers):\n    return min(numbers), max(numbers), sum(numbers) / len(numbers)\n```',codeExample:`# Basic function
def greet(name):
    return f"Hello, {name}!"
...
print_line()
print("Section Title")
print_line("-")`,practiceCode:`# Practice functions
...
print(f"Fibonacci(10): {fibonacci(10)}")`,practiceTask:"Create functions for: Celsius to Fahrenheit conversion, checking if a number is prime, and generating Fibonacci sequences.",quiz:[{question:"What does a function return without a return statement?",options:["0","Empty string","None","Error"],correctIndex:2,explanation:"Functions without return return None."},{code:"def add(a, b=5):\n    return a + b\n\nprint(add(3))",question:"What does add(3) return?",options:["3","5","8","Error"],correctIndex:2,explanation:"b defaults to 5, so 3 + 5 = 8."}]},{slug:"lambda",title:"Lambda Functions",description:"Anonymous one-line functions.",content:`**Lambda** functions are small anonymous functions.
...
print(f"\\nBy length: {by_length}")`,practiceCode:`# Lambda practice
...
for key, value in student.items():
    print(f"  {key}: {value}")`,practiceCode:`# Dictionary practice
...
acc.deposit(500)
acc.withdraw(200)
print(acc.get_statement())`,practiceCode:`class Student:
...
print(f"Is Circle: {isinstance(c, Circle)}")`,practiceCode:`class Vehicle:
...
print(car.drive(50))
print(car.drive(100))
print(car.charge())`,practiceTask:"Create a Vehicle class and extend it with ElectricCar that adds battery tracking and charging.",quiz:[{question:"What does super().__init__() do?",options:["Creates new class","Calls parent constructor","Destroys object","Nothing"],correctIndex:1,explanation:"super().__init__() calls the parent class's constructor."},{question:"Can a child class override a parent method?",options:["No, never","Yes, by redefining it","Only with permission","Only static methods"],correctIndex:1,explanation:"Child classes override parent methods by redefining them."}]},{slug:"oop-attributes",title:"Attributes",description:"Class and instance attributes.",content:'**Attributes** are named values attached to a class or its objects.\n\n**Two kinds:**\n- **Class attribute** - defined directly in the class body, shared by ALL instances\n- **Instance attribute** - set on `self` inside methods, unique to each object\n\n```python\nclass Employee:\n    company = "Acme"    # class attribute (shared)\n\n    def __init__(self, name):\n        self.name = name   # instance attribute (per object)\n```\n\n**Attribute rules:**\n- Read/write with dot notation: `obj.name`, `obj.name = "Annie"`\n- Deleting: `del obj.name`\n- If you assign to an attribute on an object, Python creates an instance attribute that shadows the class attribute\n- `obj.attr` lookup order: instance → class → parent classes\n- `obj.__dict__` shows the instance\'s own attributes\n- Get/set dynamically with `getattr(obj, name)`, `setattr(obj, name, value)`, `hasattr(obj, name)`',codeExample:`class Counter:
...
print(a.__dict__)
print(Counter.__dict__)   # 'total' lives on the class`,practiceCode:`# Practice: class vs instance attributes
class Player:
...
print(Player.game)`,practiceTask:"Create a Player class with a class attribute 'game' and instance attributes name/hp, then demonstrate how assigning to one instance shadows the class attribute.",quiz:[{question:"What is a class attribute?",options:["Unique per object","Shared by all instances","Always private","A method"],correctIndex:1,explanation:"A class attribute is defined on the class and shared by all instances."},{question:"Where do instance attributes usually get created?",options:["Class body","__init__ via self.attr","No methods","At import time"],correctIndex:1,explanation:"Instance attributes are typically created inside __init__ using self."}]},{slug:"oop-methods",title:"Methods",description:"Functions defined inside a class.",content:"A **method** is a function that belongs to a class. It is called on an object (or class) using dot notation.\n\n**Three kinds of methods:**\n- **Instance method** - first argument `self` (the object); can access object state\n- **Class method** - decorated with `@classmethod`, first argument `cls` (the class)\n- **Static method** - decorated with `@staticmethod`, no `self` or `cls`\n\n```python\nclass Math:\n    @staticmethod\n    def add(a, b):\n        return a + b\n\n    @classmethod\n    def create(cls):\n        return cls()\n```\n\n**Key method rules:**\n- Instance methods need `self` as the first parameter\n- You call methods with parentheses: `obj.method()`\n- `obj.method()` is shorthand for `ClassName.method(obj)`\n- `@classmethod` receives the class, not the instance\n- `@staticmethod` behaves like a plain function but lives in the class namespace\n- Methods can read `inspect`? No - they simply use `self` to touch attributes",codeExample:`class Greeter:
    @classmethod
    def info(cls):
...
print(Greeter.info())              # class method`,practiceCode:`# Practice: three kinds of methods
class Calculator:
    @staticmethod
    def add(a, b):
        return a + b
...
print(c.add(10, 20))               # static works on instance too`,practiceTask:"Create a Calculator with a static add method, a class method describe, and an instance multiply method, then call all three.",quiz:[{question:"What decorator creates a class method?",options:["@staticmethod","@classmethod","@property","@method"],correctIndex:1,explanation:"@classmethod makes a method that receives the class as cls."},{question:"What is the first parameter of an instance method?",options:["cls","self","instance","this"],correctIndex:1,explanation:"Instance methods receive self, the object itself."}]},{slug:"oop-self-cls",title:"self, cls Keywords",description:"self binds to instances, cls to the class.",content:"`self` and `cls` are conventional names for the first parameters of methods.\n\n- **`self`** - used in instance methods. It refers to the CURRENT object that called the method. It lets the method read/write that object's attributes.\n- **`cls`** - used in class methods (`@classmethod`). It refers to the CLASS itself, so the method can access class attributes or create new instances.\n\n```python\nclass V:\n    count = 0\n    def __init__(self):\n        self.x = 1          # self = the new object\n    @classmethod\n    def make(cls):          # cls = the class V\n        return cls()\n    @staticmethod\n    def helper():\n        pass                # neither self nor cls\n```\n\n**Rules:**\n- `self` and `cls` are just names; Python passes the object/class automatically\n- The name `self` is convention, but always use it for readability\n- Calling `obj.method()` passes obj as `self`; calling `Class.method(obj)` works too\n- `cls.method()` can create instances with `cls()` (useful in factories)\n- A method that needs neither is a `@staticmethod`",codeExample:`class Account:
    total = 0
...
print(b.amount)`,practiceCode:`# Practice: self and cls
class Robot:
    count = 0
...
print(Robot.count)`,practiceTask:"Create a Robot class using self for instance work and cls for class methods that count robots and create new robots.",quiz:[{question:"What does self refer to inside an instance method?",options:["The class","The current object","The module","Nothing"],correctIndex:1,explanation:"self refers to the current instance (object) that called the method."},{question:"What does cls refer to inside a @classmethod?",options:["The instance","The class itself","The parent","The function"],correctIndex:1,explanation:"cls refers to the class itself, not an instance."}]},{slug:"oop-special-methods",title:"__init__, __new__, __del__ Methods",description:"The object lifecycle: creation, initialization, destruction.",content:'These dunder (double underscore) methods control an object\'s lifecycle.\n\n**`__init__(self, ...)`** - the initializer. Called right after an object is created, it sets up instance attributes.\n\n**`__new__(cls, ...)`** - the allocator. Called BEFORE `__init__` to create and return the instance. Rarely overridden; used for singletons or immutable types.\n\n**`__del__(self)`** - the destructor. Called when the object is about to be garbage collected (or the process ends).\n\n```python\nclass Demo:\n    def __new__(cls, *a, **kw):\n        obj = super().__new__(cls)   # allocate the object\n        return obj\n\n    def __init__(self, x):\n        self.x = x\n\n    def __del__(self):\n        print("object destroyed")\n```\n\n**Lifecycle order when you call `Demo(5)`:**\n1. `__new__` runs → creates the instance\n2. `__init__` runs → initializes it\n3. Object is used\n4. `__del__` runs → cleanup before destruction\n\n**Notes:**\n- You almost never write `__new__`; let it default\n- `__del__` is not guaranteed to run immediately and is unreliable for critical cleanup\n- `del obj` removes the reference (may trigger `__del__` when refcount hits zero)',codeExample:`class Widget:
...
print("done")`,practiceCode:`# Practice: lifecycle methods
class Timer:
...
del t
print("script ending")`,practiceTask:"Create a Timer class using __new__ to set an attribute, __init__ to set another, and __del__ to print cleanup. Delete the object and observe the order.",quiz:[{question:"Which method runs first when creating an object?",options:["__init__","__new__","__del__","__str__"],correctIndex:1,explanation:"__new__ allocates the instance and runs before __init__."},{question:"What does __del__ do?",options:["Creates the object","Initializes attributes","Cleans up before destruction","Returns the instance"],correctIndex:2,explanation:"__del__ is the destructor called before the object is collected."}]},{slug:"oop-polymorphism",title:"Polymorphism",description:"One interface, many implementations.",content:`**Polymorphism** means "many forms": the same function/method works on objects of different classes as long as they expose the same interface.
...
- \`super()\` lets a child call the parent version`,codeExample:`class Shape:
    def area(self):
        return 0
...
print(sum(s.area() for s in shapes))`,practiceCode:`# Practice: polymorphism
class EBook:
    def open_page(self):
...
for x in ["hey", [1, 2, 3], {"a": 1, "b": 2}]:
    print(type(x).__name__, len(x))`,practiceTask:"Create EBook and PaperBook classes with an open_page method each, call them through one generic function, and show how len() works on different types.",quiz:[{question:"What is polymorphism?",options:["Many classes","Same interface, many behaviors","One class","No methods"],correctIndex:1,explanation:"Polymorphism lets different classes respond to the same method call."},{question:"What is duck typing?",options:["A design pattern","Behavior matters over type","Only for birds","Requires inheritance"],correctIndex:1,explanation:"Duck typing: an object's suitability depends on its methods, not its declared type."}]},{slug:"oop-encapsulation",title:"Encapsulation",description:"Hiding internal state with private members.",content:`**Encapsulation** bundles data with the methods that operate on it and hides internal details from outside access.
...
- Python is about convention, not enforcement - \`_name\` is a signal, not a wall`,codeExample:`class Account:
...
print(a.__dict__)`,practiceCode:`# Practice: encapsulation
class Vault:
    def __init__(self):
...
print(v.__dict__)`,practiceTask:"Create a Vault class with a protected _code and private __pin, a property that hides the pin, and a check_pin method to validate attempts.",quiz:[{question:"What does a double underscore before an attribute name do?",options:["Deletes it","Name mangles it","Makes it a method","Nothing"],correctIndex:1,explanation:"__name triggers name mangling to _ClassName__name, making it effectively private."},{question:"Which decorator exposes a private attribute read-only?",options:["@classmethod","@property","@static","@getter"],correctIndex:1,explanation:"@property wraps a method into attribute-style read access."}]},{slug:"oop-abstraction",title:"Abstraction",description:"Hiding implementation details with ABCs.",content:`**Abstraction** means exposing only the essential interface and hiding complex details. In OOP, Python supports this through **Abstract Base Classes (ABCs)**.
...
- \`abc.abstractmethod\` forces a common contract on all subclasses`,codeExample:`from abc import ABC, abstractmethod
...
for p in [Card(), Cash()]:        # abstract temp; no Payment()
    print(p.pay(100))
    print(p.receipt(100))`,practiceCode:`# Practice: abstraction
from abc import ABC, abstractmethod
...
for v in [Car(), Boat()]:
    print(type(v).__name__, v.move())`,practiceTask:"Create an abstract Vehicle class with an abstract move method, then implement Car and Boat subclasses and call move() on both.",quiz:[{question:"Can you instantiate an abstract class directly?",options:["Yes","No","Always","Only with args"],correctIndex:1,explanation:"Abstract classes cannot be instantiated; they only define the interface."},{question:"What decorator marks a method as abstract?",options:["@staticmethod","@abstractmethod","@classmethod","@property"],correctIndex:1,explanation:"@abstractmethod from the abc module declares a required method."}]}]},{slug:"error-handling",title:"Error Handling",icon:"alert-triangle",description:"Try/except and exception handling.",level:"intermediate",lessons:[{slug:"try-except",title:"Try / Except",description:"Handling errors gracefully.",content:`**Try/Except** catches and handles errors.
...
for v in values:
    ...
    if result is not None:
        print(f"  Converted: {result}")`,practiceCode:`# Error handling practice
...
print("\\nProcessing:")
process_file_data(data)`,practiceTask:"Write a safe division function that handles ZeroDivisionError and TypeError. Process a mixed dictionary of values.",quiz:[{question:"When does the 'else' block in try/except run?",options:["Always","Only on error","Only if no error","Never"],correctIndex:2,explanation:"The else block runs only if no exception was raised."},{question:"When does 'finally' run?",options:["Only on error","Only if no error","Always","Never"],correctIndex:2,explanation:"finally always runs, whether or not an exception occurred."}]}]},{slug:"file-handling",title:"File Handling",icon:"file-text",description:"Reading and writing files.",level:"intermediate",lessons:[{slug:"file-operations",title:"File Operations",description:"Working with files in Python.",content:`**File modes:**
\`\`\`
"r"   Read (default)
"w"   Write (overwrites)
"a"   Append
...
with open("students.json", "r") as f:
    ...
    for s in loaded["students"]:
        print(f"{s['name']}: {s['grade']}")`,practiceCode:`# File handling practice
import os
...
print(f"  Tomorrow: {tomorrow.strftime('%A')}")`,practiceCode:`import random
